...
addEventListener('mousemove', function (event) {
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(mouse, {
...
function init() {
  particles = [];
  var particlesCount = 320;
  var initialR = 20;
  var hueIncrement = 360 / particlesCount;
  for (var i = 0; i < particlesCount; i++) {
    var x = canvas.width / 2 + i * cos(Math.PI);
    var y = canvas.height / 2 + i * sin(-Math.PI);
    var color = "hsl(".concat(hueIncrement * i, ", 80%, 50%)");
    var radius = initialR * Math.random() + 0.05;
